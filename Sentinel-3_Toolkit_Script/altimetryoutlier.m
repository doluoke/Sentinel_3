...
% The result of the elevation is not change from the
% reference datum of the input file.
% Author: Modurodoluwa Okeowo, Univerity of Houston
% Date: August 08, 2015
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1: length(cycle)
    ...
    final_sampl=length(cyc_Pass);
    %cleaned=  [cleaned;cyc_Pass];
    ...
    mean(cyc_Pass(:,6)) (final_sampl*100/ini_sampl)];
end
